...
\end{equation}
Combining the bounds from equations~\eqref{eq:dSigma-bound} and~\eqref{eq:dmm-bound} via the triangl`e inequality across the summation in~\eqref{eq:dPsi}, we establish a direct Lipschitz bound for the derivative of the aggregate second-moment matrix:
