...
Generated: 2026-05-14 00:42  |  Matrix: 500×100  |  rank=5  |  Seeds: 3  |  Low-rank rank: 50  |  CV folds: 3  |  Grid points: 8
...
| Method | SNR=0.1 | SNR=0.3 | SNR=1.0 | SNR=3.0 | SNR=10.0 |
|---|---|---|---|---|---|
| `proximal_cv` | 31.6s | 32.8s | 32.8s | 39.7s | 43.0s |
| `matlap_auto` | 3.1s | 3.3s | 1.2s | 0.7s | 0.6s |
| `matlap_grid` | 4.1s | 5.3s | 5.6s | 10.3s | 12.0s |
| `lowrank_auto` | 0.1s | 0.1s | 1.8s | 0.9s | 0.6s |
| `lowrank_grid` | 2.2s | 2.4s | 3.1s | 5.5s | 6.4s |
| `lowrank_cv` | 8.6s | 9.8s | 11.1s | 21.6s | 32.1s |
| `iso_auto` | 4.7s | 4.7s | 1.9s | 1.2s | 1.4s |
| `iso_grid` | 6.2s | 6.2s | 7.3s | 14.1s | 21.9s |
| `iso_cv` | 25.6s | 26.0s | 28.6s | 57.5s | 80.2s |
